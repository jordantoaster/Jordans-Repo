...
imwrite(watermarkImage1, 'newimage1.bmp','bmp');
imwrite(watermarkImage2, 'newimage2.bmp','bmp');
imwrite(watermarkImage3, 'newimage3.bmp','bmp');
imwrite(watermarkImage4, 'newimage4.bmp','bmp');
imwrite(watermarkImage5, 'newimage5.bmp','bmp');
imwrite(watermarkImage6, 'newimage6.bmp','bmp');
...
PSNR1 = FidelityMeasure(Im, watermarkImage1);
PSNR2 = FidelityMeasure(Im, watermarkImage2);
PSNR3 = FidelityMeasure(Im, watermarkImage3);
PSNR4 = FidelityMeasure(Im, watermarkImage4);
PSNR5 = FidelityMeasure(Im, watermarkImage5);
PSNR6 = FidelityMeasure(Im, watermarkImage6);
...
watermarkSignal6 = extracting(watermarkImage6, Im, size(MyWatermark,1), 0.5, 10000);
