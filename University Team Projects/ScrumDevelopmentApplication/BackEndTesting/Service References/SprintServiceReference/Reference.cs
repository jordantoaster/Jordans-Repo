...
namespace BackEndTesting.SprintServiceReference {
    ...
    public interface ISprintService {
        ...
        bool AddSprint(string name, string startDate, string endDate, int projectId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISprintService/AddSprint", ReplyAction="http://tempuri.org/ISprintService/AddSprintResponse")]
        System.Threading.Tasks.Task<bool> AddSprintAsync(string name, string startDate, string endDate, int projectId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISprintServiceChannel : BackEndTesting.SprintServiceReference.ISprintService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SprintServiceClient : System.ServiceModel.ClientBase<BackEndTesting.SprintServiceReference.ISprintService>, BackEndTesting.SprintServiceReference.ISprintService {
        ...
        public bool AddSprint(string name, string startDate, string endDate, int projectId) {
            return base.Channel.AddSprint(name, startDate, endDate, projectId);
        }
        
        public System.Threading.Tasks.Task<bool> AddSprintAsync(string name, string startDate, string endDate, int projectId) {
            return base.Channel.AddSprintAsync(name, startDate, endDate, projectId);
        }
